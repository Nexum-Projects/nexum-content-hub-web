...
export const fallbackProducts: MenuProduct[] = [
  { id: "1", name: "Latte Vainilla", type: "DRINK", description: "Espuma cremosa y vainilla natural.", priceCents: 3000, isPublished: true, isAvailable: true, isFeatured: true },
  { id: "2", name: "Croissant de almendra", type: "FOOD", description: "Horneado del dia.", priceCents: 2200, isPublished: true, isAvailable: true },
];
